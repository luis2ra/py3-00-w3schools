# @author: https://github.com/luis2ra from https://www.w3schools.com/python/python_lists_sort.asp
...
thislist7a = ["banana", "Orange", "Kiwi", "cherry"]
thislist7a.sort(key = str.lower, reverse=True)
print(thislist7a)
